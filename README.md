...
星期日到星期四晚上11点断电断网，次日六点来电；星期五和星期六晚上12点断电，不断网。目前学校**没有宽带和IPv6**（兴许未来会有），校园网是按照流量计费。有线/无线均为0.5元/1G**（记得开学带一根网线）**，**每天有20G的上限**，但速度很快（千兆）。每逢节假日（指能放假的那种）校园网免费（不限流量）。若需要下大型游戏，有以下方法：（1）去图书馆7楼  （2）等节假日  （3）加入实验室使用无线网 。 由于校园网的价格相比光纤相对较贵，办一张校园卡是比较不错的选择。
