...
axes(h_axes);t=-5:0.001:5;y=sin(pi*t);plot(t,y,'b');title('原始信号');axis([-3 3 -1 1]);grid on;
axes(h_axes1);t=-5:0.001:5;y=sin(-pi*t);plot(t,y,'b');title('反折信号');axis([-3 3 -1 1]);grid on;
axes(h_axes2);t=-5:0.001:5;y=-sin(pi*t);plot(t,y,'b');title('倒相信号');axis([-3 3 -1 1]);grid on;
axes(h_axes3);w0=1;t=-5:0.001:5;y=sin(w0*pi*t);plot(t,y,'b');title('尺度变换');axis([-3 3 -1 1]);grid on;
axes(h_axes4);t0=0;t=-5:0.001:5;y=sin(pi*(t-t0));plot(t,y,'b');title('信号延迟');axis([-3 3 -1 1]);grid on;
