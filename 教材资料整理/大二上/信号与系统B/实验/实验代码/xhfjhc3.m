...
t=-4:pi/1000:4;b=0.5;x1=sawtooth(pi*(t+0.5),b);plot(t,x1,'b');axis([0 4 -1.5 1.5]);legend('原信号');
...
'fontname',' 隶书' ,'fontsize' ,12,'string' , '开  始  仿  真' , 'callback' , [  'xhfjhc4(h_popup,h_axes)' ] );
h_push=uicontrol(h_fig, 'style' , 'push' , ...
