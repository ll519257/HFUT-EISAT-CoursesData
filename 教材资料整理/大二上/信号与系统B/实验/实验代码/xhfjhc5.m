...
t=-4:pi/1000:4;x1=abs(sin(pi*t));plot(t,x1,'b');axis([0 3 -0.5 1.5]);legend('原信号');
...
h_popup = uicontrol(h_fig, 'Style','popupmenu','fontsize' ,9,'foregroundcolor','k','Units','normalized','Position',[0.715 0.63 0.24 0.15],'BackgroundColor','white','String',{'二次谐波信号','二次、四次谐波的合成','二次、四次、六次谐波合成','二、四、六、八次谐波合成'});
...
'fontname',' 隶书' ,'fontsize' ,12,'string' , '开  始  仿  真' , 'callback' , [  'xhfjhc6(h_popup,h_axes)' ] );
h_push=uicontrol(h_fig, 'style' , 'push' , ...
