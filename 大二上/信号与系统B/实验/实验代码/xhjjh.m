...
h_axes2=axes( 'position' ,[0.07,0.08,0.59,0.26]);xlabel('n');ylabel('x(t)*h(t)');grid on; % 定义轴位框位置
...
h_popup = uicontrol(h_fig, 'Style','popupmenu','fontsize' ,9,'foregroundcolor','k','Units','normalized','Position',[0.73 0.67 0.21 0.15],'BackgroundColor','white','String',{'离散信号1','离散信号2','离散信号3'});
h_text=uicontrol(h_fig, 'style' , 'text' , ...
...
h_popup1 = uicontrol(h_fig, 'Style','popupmenu','fontsize' ,9,'foregroundcolor','k','Units','normalized','Position',[0.73 0.49 0.21 0.15],'BackgroundColor','white','String',{'离散信号4','离散信号5','离散信号6'});
...
'fontname',' 隶书' ,'fontsize' ,11,'string' , '开  始  仿  真' , 'callback' , [  'xhjjh1(h_popup,h_popup1,h_axes,h_axes1,h_axes2)' ] );
h_push=uicontrol(h_fig, 'style' , 'push' , ...
